    ...
    <div class="order-content">
	  ...
	  <el-form :inline="true" :model="formInline" class="user-search">
        ...
        <ul>
          ...
          <li class="header">
		  	<div class='pro-img'> Job Title</div>
    <div class='pro-img'> Place of work</div>
    <div class='pro-img'> working hours</div>
    <div class='pro-img'> Number of people required</div>
    <div class='pro-img'> Salary</div>
          ...
          <li class="product-list" v-for="item in gangweixinxi" :key="item.id">
            <router-link :to="`/gangweixinxidetail/`+item.id" >
				<div class='pro-img'>{{item.gangweimingcheng}}</div>
    <div class='pro-img'>{{item.gongzuodidian}}</div>
    <div class='pro-img'>{{item.gongzuoshijian}}</div>
    <div class='pro-img'>{{item.xuqiurenshu}}</div>
    <div class='pro-img'>{{item.xinzi}}</div>
...
<script>
  export default {
    ...
    methods: {
	  ...
	  search() {
        this.getgangweixinxi(this.formInline)
      },
      // 向后端请求分类list数据
      getgangweixinxi(parameter) {
        this.$axios
               .post("/api/front/gangweixinxi", {...parameter})
                .then(res => {
                  debugger
                  this.gangweixinxi = res.data.data.list;
