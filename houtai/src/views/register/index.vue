				...
				<div class="xs6 xm4 xs3-move xm4-move">
					...
					<el-form :model="ruleForm" :rules="rules" ref="ruleForm">
						<div class="panel loginbox">
							<div class="text-center margin-big padding-big-top"><h3>Job Seekersenroll</h3></div>
							<div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
								...
								<el-form-item style="margin-left: 0px" prop="password2">
									<el-input type="password" placeholder="Please enter the account number确认Password" prefix-icon="el-icon-lock" v-model="ruleForm.password2" autocomplete="off" :show-password="true" ></el-input>
								</el-form-item>
							</div>
	...
	data() {
		return {
			...
			rules: {
				...
				password2: [{ required: true, message: '请重新输入Password', trigger: 'blur' }],
