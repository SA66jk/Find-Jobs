		...
		<el-row :gutter="15">
			<el-col :md="24" :lg="12" :xl="12" class="home-lg">
				<el-card shadow="hover">
					<div slot="header">
						<span>Enrollment Statistics (Pie Chart by Specialized)</span>
					</div>
					<div class="charts">
			...
			<el-col :md="24" :lg="12" :xl="12" class="home-lg">
				<el-card shadow="hover">
					<div slot="header">
						<span>Column charts by specialty</span>
					</div>
					<div class="charts">
						<div class="charts-left mr7">
...
<script>
	...
	import {jianlitoudi_tj_gangweimingcheng} from "@/api/jianlitoudi/jianlitoudiApi";
export default {
	name: 'user',
	data() {
		return {
	...
	methods: {
		initChart() {
			jianlitoudi_tj_gangweimingcheng().then(res=>{
				let data = res.data
				let value = []
				data.forEach(item=>{
