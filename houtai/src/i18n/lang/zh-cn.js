...
export default {
	router: {
		...
		menu2: '菜单2',
		funIndex: '功能',
		funTagsView: 'tagsView Operate',
		funSignCanvas: '在线签名',
		funCountup: 'countup 数字滚动',
		funEchartsTree: 'echartsTree 树图',
		funSelector: '图标选择器',
		funWangEditor: 'wangEditor Edit器',
		funCropper: 'cropper format裁剪',
		funMindMap: 'G6 思维导图',
		...
		resetPass:"Change your password",
	},
	staticRoutes: {
		signIn: 'login',
		notFound: '找不到此页面',
	...
	user: {
		...
		dropdown3: '404',
		dropdown4: '401',
		dropdown5: 'quit login',
		dropdown6: '代码仓库',
		searchPlaceholder: '菜单Search：支持中文、路由路径',
		newTitle: '通知',
		newBtn: '全部已读',
		newGo: '前往通知中心',
		newDesc: '暂无通知',
		logOutTitle: 'prompt',
		logOutMessage: 'This Operate will quit login, do you want to continue?',
		logOutConfirm: 'sure',
		logOutCancel: 'Cancel',
		logOutExit: 'quit中',
		logOutSuccess: 'Safe quit success！',
	},
	tagsView: {
		refresh: '刷新',
		close: '关闭',
	...
	noAccess: {
		accessTitle: '您未被授权，没有Operate权限~',
		accessMsg: 'Contact：加QQ群探讨 665452019',
		accessBtn: '重新授权',
	},
	layout: {
		configTitle: '布局配置',
	...
	upgrade: {
		title: '新版本升级',
		msg: '新版本来啦，马上update尝鲜吧！不用担心，update很快的哦！',
		desc: 'prompt：update会还原默认配置',
		btnOne: '残忍拒绝',
		btnTwo: '马上update',
		btnTwoLoading: 'update中',
	},
};
