<template>
	<div>
		...
		<el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" @selection-change="handleSelectionChange">
			...
			<el-table-column align='center' prop='touxiang' label='avatar' width='120'><template slot-scope='scope'><el-image :src='scope.row.touxiang' style='height:70px'  v-if="scope.row.touxiang"/><img src="../../../static/images/guanli.jpg" style='height:70px' v-else/></template></el-table-column>
			...
			<el-table-column align="center" label="Operate" min-width="160">
				<template slot-scope="scope">
					...
					<el-button size="mini" type="danger" @click="deleteYonghuxinxi(scope.$index, scope.row)" v-if="userInfo.roles[0] == 'guanliyuan' ">Delete</el-button>
		...
		<el-form-item  label="identity card" prop="shenfenzheng"><el-input size="small" v-model="editForm.shenfenzheng" auto-complete="off" placeholder="Please enter your ID" style='width:50%'></el-input></el-form-item>
		...
		<el-form-item  label="comment" prop="beizhu"><el-input size="small" v-model="editForm.beizhu" auto-complete="off" placeholder="Please enter a comment" style='width:50%'></el-input></el-form-item>
