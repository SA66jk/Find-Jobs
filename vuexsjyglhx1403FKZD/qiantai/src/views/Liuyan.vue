      ...
      <el-col span="24">
              ...
              <el-col span="18">
                <el-row>
                  ...
                  <div style="color: #888;margin-left: -150px;padding-top: 30px" v-for="child in item.children" :key="child.id">
                    <el-col span="4" style="text-align: center">{{child.cheng}}  Reply：</el-col>
                    <el-col span="18">
                      <el-row>
                  ...
                  <el-col span="12" style="margin-top: 20px">
                    <el-input type="text"  style="width: 70%; display: inline-block" v-model="item.replayText"/>
                    <el-button type="primary" @click="reply(item.id, item.replayText)">Reply</el-button>
                  </el-col>
                </el-row>
              </el-col>
            </el-row>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <h2 style="line-height: 80px">留言</h2>
          </div>
        </div>
        <div class="comment-item">
          <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      reply(id, content) {
        if (!content) {
          this.notifyError("请填写Replycontent");
          return;
        }
